...
function primeiraPergunta() {
    ...
    <img src="images/abaporu.jpg" alt="oi" width=250 height=350>
...
function segundaPergunta() {
    ...
    <img src="images/bumba-meu-boi.jpg" alt="Pintura da obra " width=250 height=350>
...
function terceiraPergunta() {
    ...
    <img src="images/grande-fachada-festiva.jpg" alt="Pintura da obra " width=250 height=350>
...
function quartaPergunta() {
    ...
    <img src="images/independencia.jpg" alt="Pintura da obra " width=250 height=350>
    <button id='bt1' value="correto">Rio Ipiranga</button>
    <button id='bt2' value="errado">Rio Tiete</button></br>
    <button id='bt3' value="errado">Rio Ipiranga</button>
...
// 	divCinco.innerHTML = ` <img src="images/bilhete-dourado.png" alt="Yeahhh" width=320 height=620>`;
// }
